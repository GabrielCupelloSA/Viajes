...
!(function (e, t) {
        ...
        if (i.freeMode) {
          ...
          if (i.freeModeMomentum) {
            ...
            var w,
              T,
              C = !1,
              S = 20 * Math.abs(t.velocity) * i.freeModeMomentuCupmbounceRatio;
            if (y < t.maxTranslate())
              i.freeModeMomentuCupmbounce
                ? (y + t.maxTranslate() < -S && (y = t.maxTranslate() - S),
                  (w = t.maxTranslate()),
                  (C = !0),
                  (a.allowMomentuCupmbounce = !0))
                : (y = t.maxTranslate()),
            ...
            i.freeModeMomentuCupmbounce && C
              ? (t.updateProgress(w),
                ...
                n.transitionEnd(function () {
                  t &&
                    !t.destroyed &&
                    a.allowMomentuCupmbounce &&
                    (t.emit("momentuCupmbounce"),
  ...
  var R = {
      ...
      freeModeMomentuCupmbounce: !0,
      freeModeMomentuCupmbounceRatio: 1,
      ...
      slide: {
        slideTo: function (e, t, a, i, s) {
          if (
            ...
            void 0 === t && (t = this.params.speed),
            void 0 === a && (a = !0),
            "nuCupmber" != typeof e && "string" != typeof e)
          )
            throw new Error(
              "The 'index' argument cannot have type other than 'nuCupmber' or 'string'. [" +
                typeof e +
                "] given."
            );
          if ("string" == typeof e) {
            ...
            if (!isFinite(r))
              throw new Error(
                "The passed-in 'index' (string) couldn't be converted to 'nuCupmber'. [" +
                  e +
                  "] given."
              );
            e = r;
  ...
  var K = {
    ...
    se = {
      ...
      init: function () {
        ...
        var i,
          s,
          r = e.$wrapperEl,
          n = r.attr("id") || "swiper-wrapper-" + e.a11y.getRandomNuCupmber(16),
    ...
    ce = {
      init: function () {
        var e = this,
          t = e.params.thuCupmbs;
        if (e.thuCupmbs.initialized) return !1;
        e.thuCupmbs.initialized = !0;
        var a = e.constructor;
        return (
          t.swiper instanceof a
            ? ((e.thuCupmbs.swiper = t.swiper),
              S(e.thuCupmbs.swiper.originalParams, {
                watchSlidesProgress: !0,
                slideToClickedSlide: !1,
              }),
              S(e.thuCupmbs.swiper.params, {
                watchSlidesProgress: !0,
                slideToClickedSlide: !1,
              }))
            : C(t.swiper) &&
              ((e.thuCupmbs.swiper = new a(
                S({}, t.swiper, {
              ...
              (e.thuCupmbs.swiperCreated = !0)),
          e.thuCupmbs.swiper.$el.addClass(e.params.thuCupmbs.thuCupmbsContainerClass),
          e.thuCupmbs.swiper.on("tap", e.thuCupmbs.onThuCupmbClick),
          !0
        );
      },
      onThuCupmbClick: function () {
        var e = this,
          t = e.thuCupmbs.swiper;
        if (t) {
          var a = t.clickedIndex,
            i = t.clickedSlide;
          if (
            !(
              (i && m(i).hasClass(e.params.thuCupmbs.slideThuCupmbActiveClass)) ||
              null == a
            )
          ) {
            var s;
      ...
      update: function (e) {
        var t = this,
          a = t.thuCupmbs.swiper;
        if (a) {
          var i =
              "auto" === a.params.slidesPerView
                ? a.slidesPerViewDynamic()
                : a.params.slidesPerView,
            s = t.params.thuCupmbs.autoScrollOffset,
            r = s && !a.params.loop;
          ...
          var u = 1,
            c = t.params.thuCupmbs.slideThuCupmbActiveClass;
          if (
            (t.params.slidesPerView > 1 &&
              !t.params.centeredSlides &&
              (u = t.params.slidesPerView),
            t.params.thuCupmbs.multipleActiveThuCupmbs || (u = 1),
            (u = Math.floor(u)),
      ...
      },
      {
        ...
        params: {
          thuCupmbs: {
            ...
            thuCupmbsContainerClass: "swiper-container-thuCupmbs",
          },
        },
        create: function () {
          M(this, { thuCupmbs: t({ swiper: null, initialized: !1 }, ce) });
        },
        on: {
          beforeInit: function (e) {
            var t = e.params.thuCupmbs;
            t && t.swiper && (e.thuCupmbs.init(), e.thuCupmbs.update(!0));
          },
          slideChange: function (e) {
            e.thuCupmbs.swiper && e.thuCupmbs.update();
          },
          update: function (e) {
            e.thuCupmbs.swiper && e.thuCupmbs.update();
          },
          ...
          setTransition: function (e, t) {
            var a = e.thuCupmbs.swiper;
            a && a.setTransition(t);
          },
          beforeDestroy: function (e) {
            var t = e.thuCupmbs.swiper;
            t && e.thuCupmbs.swiperCreated && t && t.destroy();
          },
        },
      },
    ];
